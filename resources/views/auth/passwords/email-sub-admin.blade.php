...
@stop
@section('content')
<form class="md-float-material form-material" method="POST" action="{{route('sub.admin.password.email')}}">
    @csrf
    ...
    <div class="auth-box card">
        <div class="card-block">
            ...
            <p class="f-w-600 text-right"><a href="{{route('sub.admin.login')}}"> Back to Login</a></p>
