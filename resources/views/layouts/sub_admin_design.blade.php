...
<html lang="en">
	<head>
		<title>Boiler Plate Sub Admin | @yield('title')</title>
		<meta charset="utf-8">
								...
								<li class="user-profile header-notification">
									<div class="dropdown-primary dropdown">
										...
										<ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
											<li>
												<a href="{{route('sub.admin.profile')}}"><i class="feather icon-user"></i> Profile</a>
											</li>
											<li>
												<a href="{{route('sub.admin.logout')}}"><i class="feather icon-log-out"></i> Logout</a>
											</li>	
										</ul>
									</div>
								</li>
								...
								<div class="pcoded-inner-navbar main-menu">
									<ul class="pcoded-item pcoded-left-item">
										<li class="{{Request::routeIs('admin.dashboard')?'active':''}}">
											<a href="{{route('sub.admin.dashboard')}}" class="waves-effect waves-dark">
